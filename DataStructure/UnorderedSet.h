...
template <typename BucketTy> struct UnorderedSetBucketTraits {
...
class UnorderedSet
    : public DenseHash<Ty, UnorderedSetBucketTraits<Ty>, AllocatorTy> {
public:
...
public:
  ...
  template <typename Iterator> UnorderedSet(Iterator First, Iterator Last) {
